...
public interface AppJwtConfigRepository extends JpaRepository<AppJwtConfigEntity, String> {
     ...
     */
    @Query(value = "SELECT NEW cn.frank.ulp.common.entity.app.po.AppJwtConfigPO(jc,a.code,a.name,a.template,a.clientId,a.clientSecret,a.initLoginUrl,a.authorizationType,a.enabled,a.configured) FROM AppEntity a INNER JOIN AppJwtConfigEntity jc ON a.id = jc.appId WHERE a.id =:appId")
     ...
     * @return {@link AppFormConfigPO}
     */
    @Query(value = "SELECT NEW cn.frank.ulp.common.entity.app.po.AppJwtConfigPO(jc,a.code,a.name,a.template,a.clientId,a.clientSecret,a.initLoginUrl,a.authorizationType,a.enabled,a.configured) FROM AppEntity a INNER JOIN AppJwtConfigEntity jc ON a.id = jc.appId WHERE a.code =:appCode")

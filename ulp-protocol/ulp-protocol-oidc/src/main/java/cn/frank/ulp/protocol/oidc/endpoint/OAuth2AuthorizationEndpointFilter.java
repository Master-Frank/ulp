...
import cn.frank.ulp.protocol.oidc.authentication.OAuth2AuthorizationImplicitAccessTokenAuthenticationToken;
...
import cn.frank.ulp.protocol.oidc.endpoint.authentication.OAuth2AuthorizationImplicitRequestAuthenticationConverter;
...
import static cn.frank.ulp.protocol.oidc.endpoint.OAuth2EndpointUtils.appendUrl;
import static cn.frank.ulp.protocol.oidc.endpoint.OAuth2ParameterNames.FRAGMENT;
import static cn.frank.ulp.protocol.oidc.endpoint.OAuth2ParameterNames.RESPONSE_MODE;
import static cn.frank.ulp.protocol.oidc.endpoint.authentication.OAuth2AuthorizationImplicitRequestAuthenticationConverter.ID_TOKEN;
import static cn.frank.ulp.protocol.oidc.endpoint.authentication.OAuth2AuthorizationImplicitRequestAuthenticationConverter.TOKEN;

...
public final class KeyStringRedisSerializer implements RedisSerializer<String> {
    ...
    */
    ...
    public byte[] serialize(@Nullable String stringValue) {
        return stringValue == null ? null
            : (this.keyPrefix + stringValue).getBytes(StandardCharsets.UTF_8);
    }
    ...
    */
    ...
    public String deserialize(@Nullable byte[] byteValue) {
        return byteValue == null ? null
            : (new String(byteValue, StandardCharsets.UTF_8)).replaceFirst(this.keyPrefix, "");
    }

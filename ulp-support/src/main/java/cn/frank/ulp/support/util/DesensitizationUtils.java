...
public class DesensitizationUtils {
    ...
    public static String idPassport(String str, int length) {
        ...
        return org.apache.commons.lang3.StringUtils.isBlank(str) ? ""
            : org.apache.commons.lang3.StringUtils.rightPad(
                org.apache.commons.lang3.StringUtils.left(str,
                    (strLength = org.apache.commons.lang3.StringUtils.length(str)) - length),
                strLength, "*");
    }
        ...
        return org.apache.commons.lang3.StringUtils
            .isBlank(str)
                ...
                : org.apache.commons.lang3.StringUtils
                    .left(str,
                        leftLength)
                    .concat(org.apache.commons.lang3.StringUtils
                        .removeStart(org.apache.commons.lang3.StringUtils.leftPad(
                            org.apache.commons.lang3.StringUtils.right(str, rightLength),
                            org.apache.commons.lang3.StringUtils.length(str), "*"), "*"));
    }
    ...
    public static String right(String str, int length) {
        return org.apache.commons.lang3.StringUtils.isBlank(str) ? ""
            : org.apache.commons.lang3.StringUtils.leftPad(
                org.apache.commons.lang3.StringUtils.right(str, length),
                org.apache.commons.lang3.StringUtils.length(str), "*");
    }
    ...
    */
    public static String emailEncrypt(String email) {
        return org.apache.commons.lang3.StringUtils.isBlank(email) ? ""
            : email.replaceAll("(^\\w{1})[^@]*(@\\w+)", "$1****$2");
    }
    ...
    */
    public static String left(String str, int length) {
        return org.apache.commons.lang3.StringUtils.isBlank(str) ? ""
            : org.apache.commons.lang3.StringUtils.rightPad(
                org.apache.commons.lang3.StringUtils.left(str, length),
                org.apache.commons.lang3.StringUtils.length(str), "*");
    }
